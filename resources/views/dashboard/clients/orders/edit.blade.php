            ...
            <div class="card-body">
                <div class="col-lg-12 margin-tb">
                    <div class="pull-right">
                        <a class="btn btn-primary btn-sm" href="{{ route('dashboard.orders.index') }}">@lang('site.back')</a>
                    </div>
                </div><br>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        class="btn btn-sm btn-click
                                            {{ in_array($product->id,$order->products->pluck('id')->toArray())? 'disabled btn-default': 'btn-success' }}"
            ...
            <div class="card-body">
                ...
                <div class="table-responsive">
                    <form
                        ...
                        action="{{route('dashboard.client.orders.update', [$order->clients->id, $order->id])}}"
                        method="POST"
                    >
                        ...
                        <table class="table table-hover"  style=" text-align: center;">
                            ...
                            <tbody class="row-now">
                                ...
                                <tr id="order-{{ $product->id }}">
                                    ...
                                    <td class='price-order' id='price-{{ $product->id }}'>
                                        {{ number_format($product->pivot->amount * $product->sale_price,2) }}
                                    </td>
                                    <td>
