        ...
        <div class="card">
            <div class="card-body">
                ...
                <form class="parsley-style-1"
                    ...
                    autocomplete="off"
                    name="selectForm2"
                    action="{{route('dashboard.product.store','test')}}"
                    method="post"
                    ...
                    <div class="">
                        ...
                        <div class="row mg-b-20">
                            ...
                            <div class="parsley-input col-md-12 mg-t-20 mg-md-t-0" id="lnWrapper">
                                ...
                                <textarea class="form-control ckeditor" id="summary-ckeditor" name="description"></textarea>
                            </div>
                        ...
                        <div class="row mg-b-20">
                            ...
                            <div class="parsley-input col-md-6 mg-t-20 mg-md-t-0" id="lnWrapper">
                                ...
                                <input
                                    ...
                                    >
                                    <img src="{{URL::asset('assets/img/product/6.jpg')}}"
                                        alt="profile"
                                        width="100px"
                                        class="img-thumbnail"
                                        id="output"
                            ...
                            <div class="parsley-input col-md-6" id="fnWrapper">
                                ...
                                <input class="form-control form-control-sm mg-b-20"
                                    data-parsley-class-handler="#lnWrapper" step="0.01" name="purchase_price" required type="number">
                            </div>

                            <div class="parsley-input col-md-6" id="fnWrapper">
                                <label>@lang('site.sale_price') : <span class="tx-danger">*</span></label>
                                <input class="form-control form-control-sm mg-b-20"
                                    data-parsley-class-handler="#lnWrapper" step="0.01" name="sale_price" required type="number">
                            </div>

                            <div class="parsley-input col-md-6" id="fnWrapper">
                                <label>@lang('site.stock') : <span class="tx-danger">*</span></label>
                                <input class="form-control form-control-sm mg-b-20"
                                    data-parsley-class-handler="#lnWrapper" name="stock" required type="number">
                            </div>
