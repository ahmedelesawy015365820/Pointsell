...
class RoleController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('dashboard.roles.index')->with('success', trans('site.success'));
    ...
    public function destroy(Request $request)
    {
        ...
        return redirect()->route('dashboard.roles.index')->with('success', trans('site.true-delete'));
    }
}
